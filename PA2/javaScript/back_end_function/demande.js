async function getInfoD(data) {
    ...
    }else if(data.etat === "valide" || data.etat === "en cour" || data.etat === "a valider"){
        button = button.concat(
            "           <button class=\"annuler\" onclick='cancelAsk(" + data.id + ")'>Annuler</button>\n" +
            "           <button class=\"supp\">Supprimer</button>\n" +
            "       </div>\n" +
...
async function affichageDemande(data) {
    var filtre =
        ...
        "           <option value='en_cour' onclick='trieTypeD(\"aide_service_administratif\")'>Aide service administratif</option>" +
        "           <option value='valider' onclick='trieTypeD(\"demande_navette\")'>Navette</option>" +
        "           <option value='en_attente_validation' onclick='trieTypeD(\"demande_visite\")'>Visite</option>" +
        ...
        "           <option value='fait' onclick='trieStateD(\"en cours\")'>En cours</option>" +
