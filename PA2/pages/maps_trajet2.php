  ...
  <body>
      ...
      <div class="commutes-info">
        <div class="commutes-initial-state">
          ...
          <div class="description">
            <h1 class="heading">Estimer le temps de trajet</h1>
            <p>Voir le temps de trajet et les directions pour les lieux à proximité</p>
          </div>
          <button class="add-button" autofocus>
            <svg aria-label="Add Icon" width="24px" height="24px" xmlns="http://www.w3.org/2000/svg">
              <use href="#commutes-add-icon"/>
            </svg>
            <span class="label">Ajouter destination</span>
          </button>
    ...
    <div class="commutes-modal-container">
      <div class="commutes-modal" role="dialog" aria-modal="true" aria-labelledby="add-edit-heading">
        <div class="content">
          <h2 id="add-edit-heading" class="heading">Ajouter destination</h2>
          <form id="destination-form">
            <input type="text" id="destination-address-input" name="destination-address" placeholder="Entrez une adresse" autocomplete="off" required>
      ...
      function initCommutesPanel() {
        ...
        addCommutesButtonEls.forEach(addButton => {
          addButton.addEventListener('click', () => {
            destinationModalEl.title.innerHTML = 'Ajouter destination';
    ...
    <script>
      const CONFIGURATION = {
        ...
        "mapOptions": {"center":{"lat":48.8461299,"lng":2.3855557},"fullscreenControl":true,"mapTypeControl":false,"streetViewControl":false,"zoom":13,"zoomControl":true,"maxZoom":20,"mapId":""},
        "mapsApiKey": "AIzaSyCGV0C68ZFvy3tbbeOlD1u8_8DxBg_LVxU"
      };
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGV0C68ZFvy3tbbeOlD1u8_8DxBg_LVxU&callback=initMap&libraries=places,geometry&solution_channel=GMP_QB_commutes_v2_c" async defer></script>
  </body>
</html>